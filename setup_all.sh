...
echo "1. Source the venv: source software/venv/activate"
echo "2. Run Capture:     python software/src/capture.py"
echo "3. Run Engine:      python software/src/host_engine.py"
echo "======================================================="
